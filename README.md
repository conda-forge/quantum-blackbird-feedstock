...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/quantum-blackbird-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14737&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/quantum-blackbird-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `quantum-blackbird` can be installed with:

```
conda install quantum-blackbird
```

It is possible to list all of the versions of `quantum-blackbird` available on your platform with:
